...
Ce document présente le mini projet (POC) réalisé pour valider, pour la partie VM, le système de gestion des certificats Let's Encrypt.

# 2. Architecture et principes 
 ![Upload to VM](./img/POC-VMLinux.jpg)
